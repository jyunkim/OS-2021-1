...
- **개념 예습**
    ...
    ![./image/Synchronization1.PNG](./image/Synchronization1.PNG)

    ![./image/Synchronization2.PNG](./image/Synchronization2.PNG)
    ...
    단점 - 지원하는 언어에서만 사용 가능 - 컴파일러가 OS를 이해해야 함
    ...
    **Fragmentation**   
    ...
    ![./image/paging.PNG](./image/paging.PNG)
    ...
    **Effective access time**
    ...
    ![./image/performance.PNG](./image/performance.PNG)
    ...
    **목표**   
    ...
    - direct access(random)
        ...
        ![./image/filesys.PNG](./image/filesys.PNG)
    ...
    정보의 integrity를 보호하기 위해 사용자 인증 보장 unauthorized access, malicious destruction, accidental introduction 등 으로부터 computer resource 보호
    ...
    **Type** - confidentiality - integrity - availability - Theft of service - Denial of service(Dos)
